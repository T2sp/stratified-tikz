...
This document describes the development roadmap for StratifiedTikZ.

The guiding principle is:

* Keep the mathematical data model explicit.
* Keep UI/editor state separate from persistent diagram data.
* Make TikZ output readable and editable by humans.
* Add advanced geometry only after the basic editing loop is reliable.

In this project, an n-stratum means a stratum of codimension n.
