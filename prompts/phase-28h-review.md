# Phase 28H Review Prompt: Coons direction lifecycle and overlay panel cleanup
...
- Coons direction closes on tool/subtool change;
- stays open while still editing Coons directions;
- closes on Finish/Cancel/load;
- Coons creation still works;
- no stale overlay state.

Medium issues include direction window persisting outside Coons workflow or closing while user is still editing directions.
