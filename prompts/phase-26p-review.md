# Phase 26P Review Prompt: Coordinate multi-selection translation polish, docs, and regression hardening
...
Phase 26P should polish/harden coordinate multi-selection and translation.
...
- docs updated;
- coordinate-only policy clear;
- Inspector translation documented;
- drag translation documented;
- snap relation documented;
- refs remain live under coordinate translation;
- layer translation detach distinction documented/tested;
- save/load/TikZ combined tests exist;
- undo/redo robust;
...
- mixed selection ambiguity;
- coordinate translation detaches layer-bound refs;
- layer translation moves anchors;
- save/load or TikZ loses refs.
