# Phase 20D Review Prompt: Projected render primitive and depth model
...
Phase 20D should introduce projected render primitives and depth metadata without changing visible output semantics yet.

## Review checklist

Check:

- projected primitive model exists;
- surface faces extracted;
- curve segments extracted;
- points extracted;
- depth convention documented/tested;
- projection/depth finite;
- source/layer/original index preserved;
- no diagram mutation;
- existing output unchanged;
- adequate coverage for ruled/Coons/curved surfaces.

Medium issues include:

- non-finite depth;
- unclear depth convention;
- mutating diagram during extraction;
- missing surface face extraction.
