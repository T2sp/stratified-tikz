# Phase 24F Review Prompt: Layer merge and layer translation symbolic hardening
...
Phase 24F should add layer merge and harden layer translation for symbolic coordinates.

## Review checklist

Check:

- merge UI/helper exists;
- source->target moves all elements;
- metadata policy correct;
- source==target rejected;
- View/New layer handling clear;
- selection cleanup;
- undo/redo merge;
- layer translation uses symbolic-aware helpers;
- symbolic expressions preserved/updated;
- frame origins translated only;
- 2D z remains 0;
- no affine rotate/scale/shear implemented.

Medium issues include:

- merge drops labels/objects;
- metadata stale;
- new layer points to deleted source;
- symbolic translation replaced by preview numbers;
- unsupported layer objects partially mutated.
