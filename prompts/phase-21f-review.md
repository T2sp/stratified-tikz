# Phase 21F Review Prompt: UI overhaul polish, accessibility, and regression hardening
...
Phase 21F should polish and harden the full UI overhaul.

## Review checklist

Check:

- overlay stacking sane;
- overlay clicks don't trigger canvas;
- canvas interactions still work;
- responsive layout usable;
- major buttons have labels;
- toolbar/direct drawer/inspector/layer/camera do not conflict;
- open/closed UI states do not affect saved diagram/TikZ;
- copy/download works;
- save/load works;
- major creation/editing workflows work;
- docs/help text updated.

Medium issues include:

- overlays block core editing;
- controls unreachable on normal screen sizes;
- UI state saved into diagram unintentionally;
- major workflows broken after redesign.
