# Phase 26J Review Prompt: Layer translation detach for coordinate references
...
- coordinate anchors do not move;
- translated-layer refs detach;
- detached coords translate;
- other-layer refs remain linked;
- symbolic/local sources preserved appropriately;
- no dangling refs;
- undo/redo works;
- existing layer translation unchanged.

Medium issues include anchor movement, endpoint not moving, other-layer refs detaching, or symbolic data being lost.
