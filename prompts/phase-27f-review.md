# Phase 27F Review Prompt: Phase 27 docs, combined tests, and interaction hardening
...
Phase 27F should polish and harden all Phase 27 features.
...
- docs updated;
- selection cycling documented;
- inline path nodes documented;
- path splitting documented;
- style eyedropper documented;
- Arbitrary path naming documented;
- combined tests exist;
- save/load/TikZ robust;
