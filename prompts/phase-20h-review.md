# Phase 20H Review Prompt: Auto-visibility TikZ export hardening and docs
...
Phase 20H should harden TikZ export, performance, docs, and examples for ruled/Coons surfaces and auto visibility.

## Review checklist

Check:

- sorted surface export deterministic;
- hidden curve export present when enabled;
- disabled mode preserves prior behavior;
- inline no blank lines preserved;
- 4-space indentation preserved;
- no NaN/Infinity;
- sampling/performance caps;
- docs mention limitations;
- no required dependency on tikz-3dtools/LuaLaTeX;
- examples validate if added;
- save/load works.

Medium issues include:

- export can freeze on large sampling;
- inline formatting regressed;
- hidden/visible output nondeterministic;
- docs overpromise exact visibility.
