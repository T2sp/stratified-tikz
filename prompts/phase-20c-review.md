# Phase 20C Review Prompt: Coons patch creation, SVG preview, and TikZ export
...
Phase 20C should add creation/render/export for Coons patches from four boundary paths.
...
- bottom/right/top/left roles clear;
- corner compatibility validated;
- invalid corners rejected;
- boundaries copied;
...
- boundary order ambiguous;
- inconsistent corners accepted;
- surface invisible;
- TikZ export missing/invalid;
- source boundaries live-linked.
