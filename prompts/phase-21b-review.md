# Phase 21B Review Prompt: Floating SVG Preview toolbar and tool model cleanup
...
Phase 21B should move tool controls into a compact floating SVG Preview toolbar and simplify the tool model.

## Review checklist

Check:

- toolbar is inside SVG Preview;
- toolbar semi-transparent and compact;
- collapse/expand works;
- Undo/Redo overlay buttons visible and functional;
- Remove selected appears as right-side trash-like button;
- global direct input toggle no longer dominates;
- cursor is default;
- Add polyline/cubic Bézier available under Add path;
- Fill paths only visible in Select/Add path;
- overlay clicks don't affect canvas;
- existing creation/removal/history behavior not regressed.

Medium issues include:

- toolbar covers canvas too much and cannot collapse;
- Undo/Redo trigger canvas clicks;
- Add polyline/cubic unavailable;
- remove selected broken;
- Fill paths visible in wrong modes causing confusion.
