# Phase 28A Review Prompt: Preview-first layout and compact Examples dropdown
...
Phase 28A should make Preview the primary workspace and compact the Example bar.

## Review checklist

Check:

- Preview height is roughly 90dvh on desktop;
- responsive behavior sane;
- Examples compact after editing begins;
- Examples dropdown does not shrink Preview;
- example switching still works;
- Preview overlays still usable;
- UI state not saved;
- TikZ/export unaffected.

Medium issues include:

- Preview height still small due to Example/header layout;
- Examples push Preview down during editing;
- dropdown breaks example switching;
- layout causes horizontal/vertical overlay breakage.
