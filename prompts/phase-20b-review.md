# Phase 20B Review Prompt: Ruled surface creation, SVG preview, and TikZ export
...
Phase 20B should add creation/render/export for ruled surfaces from two boundary paths.
...
- exactly two boundary paths required;
- invalid boundaries rejected;
- boundaries copied, not live-linked;
- created surface selected;
- undo/redo works if applicable;
- SVG preview visible;
- TikZ mesh export exists;
...
- surface invisible;
- source paths linked unexpectedly;
- invalid boundaries accepted;
- TikZ export missing/invalid;
- sampling excessive by default.
