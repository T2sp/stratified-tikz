# Phase 24C Review Prompt: Bulk style/layer/delete/duplicate editing
...
Phase 24C should add bulk style/layer/delete/duplicate operations for multi-selection.

## Review checklist

Check:

- bulk style editor appears for same geometric kind;
- mixed values handled clearly;
- editing a field applies to all selected objects;
- bulk layer change works;
- bulk delete removes all selected and clears selection;
- bulk duplicate creates new ids and selects duplicates;
- undo/redo works;
- crossing states cleaned where needed;
- TikZ/SVG update;
- selection not saved.
...
- duplicate id reuse;
- mixed values overwrite fields unintentionally;
- bulk delete leaves stale crossings/selection;
- bulk layer change corrupts filters;
- undo/redo broken.
