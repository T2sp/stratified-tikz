# Phase 28E Review Prompt: Toolbar eyedropper and imported TikZ style shortcut dropdown
...
Phase 28E should expose eyedropper and imported TikZ styles from toolbar/context shortcuts.

## Review checklist

Check:

- eyedropper available from toolbar;
- same-kind apply works;
- cross-kind rejected;
- geometry/layer/id not copied;
- imported style dropdown appears when styles imported;
- search/recent works;
- applying imported style avoids duplicate explicit options;
- later quick edits become overrides;
- multi-selection atomic;
- undo/redo works.

Medium issues include:

- imported style bloats TikZ with duplicate options;
- eyedropper copies geometry/layer;
- cross-kind corrupts target;
- coordinate anchors get style;
- undo/redo broken.
