# Phase 25C Review Prompt: Preview refresh, JSON import, and geometry integration
...
Phase 25C should integrate local symbolic coordinates with variable refresh, JSON import, and broader geometry.

## Review checklist

Check:

- variable changes refresh local previews;
- import detects local/frame variables;
- import variable dialog works;
- cancel safe;
- supported geometry coverage clear;
- unsupported cases rejected;
- no stale previews accepted;
- no NaN/Infinity;
- global symbolic import unaffected.

Medium issues include:

- variables in local coordinates missed;
- stale previews accepted;
- imported local sources crash;
- unsupported geometry saved invalid data;
- preview not updated after variable change.
