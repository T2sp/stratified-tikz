# Phase 28B Review Prompt: SVG Preview export button and sticky edge actions
...
Phase 28B should add Export SVG and right-bottom below sticky edge action layout.

## Review checklist

Check:

- Export SVG button appears near right-bottom below Preview frame;
- button does not conflict with Layer button;
- exported SVG is standalone;
- editor chrome excluded;
- diagram content included;
- current view reflected;
- layer visibility respected;
- TikZ export unaffected.

Medium issues include:

- exported SVG includes toolbar/buttons;
- button covers important diagram content;
- exported file not standalone;
- Preview edge layout breaks Layer button.
