# Phase 25F Review Prompt: Work-plane-local symbolic polish, docs, and regression hardening
...
Phase 25F should polish and harden local symbolic coordinate support.

## Review checklist

Check:

- docs cover local symbolic coordinates;
- global translation policy documented;
- examples/tests cover R*cos(q), R*sin(q);
- save/load robust;
- variable resolution robust;
- TikZ export readable;
- inline no blank lines;
- global translation preserves local expressions;
- cursor snap relation clear;
- limitations documented;
- existing global/numeric features not regressed.

Medium issues include:

- docs contradict behavior;
- local expressions lost in combined workflows;
- import/export broken;
- inline formatting regressed;
- numeric/global diagrams affected.
