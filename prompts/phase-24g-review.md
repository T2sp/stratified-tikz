# Phase 24G Review Prompt: Editing polish, docs, and regression hardening
...
Phase 24G should polish and harden Phase 24 editing features.
...
- docs updated;
- snap/multi-select/bulk/path concat/layer merge documented;
- affine transforms clearly deferred;
- status/error messages useful;
- combined workflow tests exist;
- save/load/undo/redo robust;
- TikZ/SVG output unaffected by UI-only state;
- inline output no blank lines;
- no major editing performance issue.

Medium issues include:

- docs contradict behavior;
- selection saved accidentally;
- undo/redo broken in combined workflows;
- symbolic translation not preserved;
- path concatenation leaves stale crossings.
