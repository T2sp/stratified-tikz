# Phase 22F Review Prompt: Arrow/braiding polish, docs, and regression hardening
...
Phase 22F should polish and harden arrow/braiding features.
...
- intersection detection capped;
- save/load round-trips;
- no knot package dependency;
- inline output no blank lines;
- 4-space indentation;
- 2D braiding works;
- 3D arrows work;
- 3D braiding disabled.

Medium issues include:

- dense diagrams freeze;
- save/load loses crossing states;
- docs overpromise exact knot behavior;
- arrow/braiding TikZ broken together;
- 3D braiding incorrectly allowed.
