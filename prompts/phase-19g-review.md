# Phase 19G Review Prompt: Symbolic input and grid polish, docs, and regression hardening
...
Phase 19G should polish symbolic input/grid generation and harden combined workflows.

## Review checklist

Check:

- Variable Manager usable;
- expression errors clear;
- preview values shown;
- grid UI readable;
- docs updated;
- examples added if requested;
- combined variable/symbolic/grid tests exist;
- save/load works;
...
- user can easily create broken TikZ;
- save/load loses symbolic data;
- inline export broken;
- grid UI unusable;
- docs missing key limitations.
