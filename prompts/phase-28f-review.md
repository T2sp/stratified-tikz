# Phase 28F Review Prompt: Work-plane overlay editor and work-plane-local polar coordinate input
...
Phase 28F should add work-plane overlay and local polar coordinate input.

## Review checklist

Check:

- Work-plane overlay left-bottom in 3D;
- hidden/disabled in 2D;
- overlay z-index/layout okay;
- Add coordinate/point local polar input works;
- numeric polar conversion correct;
- symbolic polar expressions preserved;
- direct input not snapped;
- origin reference shown;
- save/load/TikZ work.

Medium issues include:

- polar input converts to stale/numeric only;
- active work-plane origin wrong;
- overlay blocks critical controls;
- 2D shows confusing work-plane editor.
