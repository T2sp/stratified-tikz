# Phase 20G Review Prompt: Point/label visibility options and auto-visibility UI
...
Phase 20G should add auto-visibility UI/options and point/label visibility behavior.

## Review checklist

Check:

- visibility UI exists;
- defaults conservative;
- surface sort/curve occlusion toggles wired;
- hidden curve style configurable or documented;
- hidden points dim/hide according to option;
- labels foreground by default or policy clear;
- layer manager/filter semantics preserved;
- visibility options save/load if they affect TikZ;
- old diagrams load;
- approximation limitations documented.

Medium issues include:

- auto visibility always on unexpectedly;
- layer filter ignored;
- hidden point/label behavior inconsistent;
- options affect SVG but not TikZ without documentation.
