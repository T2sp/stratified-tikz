# Phase 27D Review Prompt: Style eyedropper for same geometric kind
...
Phase 27D should add style copy/paste or eyedropper for same geometric kind.

## Review checklist

Check:

- style copy source works;
- paste to same kind works;
- cross-kind rejected;
- coordinate anchors excluded;
- geometry/layer/id not copied;
- relevant style fields copied;
- multi-selection target works atomically;
- undo/redo works;
- TikZ output updates.

Medium issues include:

- geometry/layer copied accidentally;
- cross-kind style corrupts target;
- partial application on mixed selection;
- coordinate anchors get style fields;
- undo/redo broken.
