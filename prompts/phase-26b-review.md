# Phase 26B Review Prompt: Add coordinate cursor/direct input and basic Preview marker
...
Phase 26B should add Add coordinate cursor/direct creation and basic Preview selection.

## Review checklist

Check:

- Add coordinate distinct from Add point;
- cursor creation creates coordinate anchor;
- no layer assigned;
- 2D z=0;
- snap applies only to cursor creation;
- direct global/local symbolic input works;
- direct input not snapped;
- marker visible/selectable;
- created coordinate selected;
- undo/redo works;
- TikZ export includes coordinate.

Medium issues include:

- coordinate created as point stratum;
- direct symbolic input converted to preview number;
- coordinate gets layer/codim;
- snap affects direct input;
- marker impossible to select.
