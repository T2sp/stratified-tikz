# Phase 15H Review Prompt: Reference-diagram presets and export hardening
...
Phase 15H should add reference-style examples/presets and harden export for filled and curved surface diagrams.
...
- examples validate;
- examples include filled regions/sheets, curved surfaces, paths, points, labels, axes;
- examples are editable;
- SVG/TikZ generation works;
- no NaN/Infinity;
- output size reasonable;
- presets useful and not overbuilt;
- existing examples not regressed;
- docs mention limitations.

Medium issues include invalid examples, huge invalid TikZ output, or examples not editable.
