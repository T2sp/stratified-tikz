# Phase 27C Review Prompt: Path splitting at an interior point
...
Phase 27C should split paths at an interior point.
...
- split UI exists;
- line/polyline split works;
- cubic split correct via De Casteljau;
- arc/template policy clear;
- unique ids generated;
- style/arrow policy documented;
- coordinate refs preserved where applicable;
- inline nodes/crossings handled;
- undo/redo works;
- TikZ valid;
- no stale refs.
...
- source path mutated unexpectedly;
- cubic split mathematically wrong;
- crossings left stale;
- duplicate ids;
- unsupported segments partially mutate diagram.
