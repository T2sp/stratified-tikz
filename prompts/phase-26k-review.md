# Phase 26K Review Prompt: Coordinate anchor integration polish, save/load, TikZ, and docs
...
- docs cover full feature;
- examples/tests cover coordinate refs;
- show/hide UI-only;
- delete detach robust;
- layer translation detach robust;
- save/load no dangling refs;
- TikZ output correct;
- undo/redo robust;
- inline no blank lines;
- traversal bounded.

Medium issues include docs contradicting behavior, detach losing symbolic intent, save/load dangling refs, or undo/redo breakage.
