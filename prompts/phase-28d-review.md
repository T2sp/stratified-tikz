# Phase 28D Review Prompt: Context quick style bar with 0.1-step sliders and custom numeric input
...
Phase 28D should add context style shortcuts and snapped sliders.

## Review checklist

Check:

- context bar appears for supported selections;
- stroke width/radius sliders use 0.1 step;
- custom numeric input allowed;
- invalid drafts allowed and warned;
- invalid drafts do not mutate diagram;
- mixed values handled;
- multi-selection applies atomically;
- coordinate anchors excluded;
- undo history not spammed;
- TikZ output reflects changes.

Medium issues include:

- invalid input commits NaN;
- slider creates many undo entries;
- mixed selection partially applies;
- coordinate anchors get style UI;
- Inspector style editing regressed.
