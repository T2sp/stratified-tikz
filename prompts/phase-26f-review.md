# Phase 26F Review Prompt: Coordinate anchor core docs and regression hardening
...
Phase 26F should polish/harden core coordinate anchors before detach work.

## Review checklist

Check:

- docs explain coordinate vs point;
- Add coordinate workflow documented;
- references documented;
- TikZ export order documented;
...
- refs fail after save/load;
- TikZ uses coordinate before definition;
- layer state affects coordinates;
- old diagrams fail.
