# Phase 28G Review Prompt: Work-plane setup UX overhaul with origin + normal vector
...
Phase 28G should improve work-plane setup UX.

## Review checklist

Check:

- method order correct;
- Pick 3 accepts points and coordinate anchors;
- hidden anchors not pickable;
- Origin + normal vector method works;
- theta/phi convention clear;
- basis deterministic/valid;
- normal preview visible;
- custom 3 points still works.

Medium issues include invalid frames, ambiguous theta/phi, broken existing pick workflow, or coordinate anchors silently numericizing in wrong places.
