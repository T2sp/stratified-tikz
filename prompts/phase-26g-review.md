# Phase 26G Review Prompt: Coordinate anchor marker, show/hide toggle, and hit-test priority
...
- marker is dot plus dotted circle;
- marker distinct from point;
- show/hide toggle works;
- hidden anchors do not intercept clicks;
- show/hide state not saved;
- TikZ unaffected;
- hit-test priority works;
- layer filter does not hide anchors.

Medium issues include hidden anchors still intercepting clicks, show/hide affecting export, or coordinate markers being indistinguishable from points.
