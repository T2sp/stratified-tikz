# Phase 26H Review Prompt: Coordinate reference inventory and detach helpers
...
- references found across supported fields;
- detach preserves symbolic/global/local where supported;
- fallback policy clear;
- no dangling refs;
- no source coordinate mutation;
- detach count correct;
- unsupported cases fail atomically.

Medium issues include missed references, stale refs, or conversion of symbolic refs to preview numbers unnecessarily.
