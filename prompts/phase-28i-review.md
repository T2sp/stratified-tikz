# Phase 28I Review Prompt: TikZ-faithful SVG arrow preview
...
- arrow kinds visually distinct;
- endpoint/mid arrows oriented correctly;
- harpoon swap differs;
- size/color/opacity follow style;
- 3D projected tangent works;
- TikZ export unchanged;
- no hit-testing/render regressions.

Medium issues include all arrow types still identical, wrong orientation, broken mid-arrow, or changed TikZ export.
