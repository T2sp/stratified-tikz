# Phase 15G Review Prompt: Hemisphere and saddle creation/editing
...
Phase 15G should add creation/editing for hemisphere and saddle surface patches.

## Review checklist

Check:

- creation UI exists for hemisphere and saddle;
- created objects are 3D codim-1 sheets;
- parameters validated;
- inspector editing works;
- style/layer editing works;
- SVG/TikZ update;
- save/load round-trip;
- undo/redo sensible;
- invalid input rejected;
- existing filled-path features not regressed.

Medium issues include invalid created surfaces, missing SVG/TikZ updates, or broken save/load.
