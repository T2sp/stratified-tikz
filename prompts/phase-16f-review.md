# Phase 16F Review Prompt: Layer Manager polish and regression hardening
...
Phase 16F should polish the Layer Manager and harden combined operation behavior.

## Review checklist

Check:

- UI is readable and grouped;
- destructive operations have confirmation or clear affordance;
- invalid operations disabled or rejected;
- status messages useful;
- combined operation tests cover rename/duplicate/swap/delete/translate/visibility;
- no duplicate IDs after duplication;
- no stale metadata after delete;
- no stale/hidden selection;
- no non-finite geometry after translation;
- TikZ generation works after layer operations;
- docs updated.

Medium issues include:

- destructive delete too easy to trigger accidentally;
- combined operations corrupt diagram;
- duplicate IDs;
- stale selections causing crashes;
- TikZ generation failing after operations.
