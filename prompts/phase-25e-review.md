# Phase 25E Review Prompt: Editing integration and translation policy for local symbolic coordinates
...
Phase 25E should integrate local symbolic coordinates with translation and editing, using object-frame-origin movement for global translation.
...
- active work plane not mutated;
- preview moves correctly;
- multi-selection/layer translation works;
- undo/redo works;
- direct symbolic input not snapped;
- same-frame path concatenation preserves local sources;
- mixed-frame policy clear;
- TikZ output remains readable.

Medium issues include:

- local expressions expanded/lost during translation;
- shared active work plane mutated;
- frame basis vectors moved/changed;
- preview not moved by global translation;
- unsupported mixed-frame path silently converted to numeric.
